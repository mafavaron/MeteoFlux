...
meteo <- read.csv("/mnt/ramdisk/Data_DL.csv");
names(meteo) <- c("Time.Stamp", "Temp.Mean", "Urel.Mean", "Rg.Mean", "Rn.Mean", "RIr.Mean", "TRIr.Mean", "Rain.Sum");
meteo$Time.Stamp <- as.POSIXct(as.character(meteo$Time.Stamp), tz="UTC");
n <- length(meteo$Time.Stamp)
sonic <- data.frame(
	Date.Time   = meteo$Time.Stamp,
	Tot.Data    = rep(0, times=n),
	Valid.Data  = rep(0, times=n),
	Vel         = rep(-9999.9, times=n),
	Vector.Vel  = rep(-9999.9, times=n),
	Scalar.Vel  = rep(-9999.9, times=n),
	Scalar.Std  = rep(-9999.9, times=n),
	Dir         = rep(-9999.9, times=n),
	Unit.Vector.Dir   = rep(-9999.9, times=n),
	Yamartino.Std.Dir = rep(-9999.9, times=n),
	Temp        = rep(-9999.9, times=n),
	Phi.Angle   = rep(-9999.9, times=n),
	Sigma.Phi.Angle   = rep(-9999.9, times=n),
	Sigma.U     = rep(-9999.9, times=n),
	Sigma.V     = rep(-9999.9, times=n),
	Sigma.W     = rep(-9999.9, times=n),
	Sigma.T     = rep(-9999.9, times=n),
	Theta       = rep(-9999.9, times=n),
	Phi         = rep(-9999.9, times=n),
	Psi         = rep(-9999.9, times=n),
	TKE         = rep(-9999.9, times=n),
	U.star      = rep(-9999.9, times=n),
	T.star      = rep(-9999.9, times=n),
	z.L         = rep(-9999.9, times=n),
	H0          = rep(-9999.9, times=n),
	H0.Plus.Density.Effect = rep(-9999.9, times=n),
	He          = rep(-9999.9, times=n),
	Eff.W       = rep(-9999.9, times=n),
	Q           = rep(-9999.9, times=n),
	C           = rep(-9999.9, times=n),
	Fq          = rep(-9999.9, times=n),
	Fc          = rep(-9999.9, times=n)
)
...
VS    <- mean(d$Vel, na.rm=TRUE);
DS    <- mean(d$Dir, na.rm=TRUE);
